...
[In this sample we look up bicycle commute stats for census tracts in San Francisco.](bike_commutes/points_in_boundaries.py)

[In another sample we look up the median age of housing units and percent of multi-unit dwellings for coastal communities in the U.S.](coastal_housing_characteristics/coastal_tracts_housing_risk.py)
